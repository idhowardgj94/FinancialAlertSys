...
<html>
	...
	<div="container">
		<div id="nav">
			...
			<a href="#" class="abgne_gotoheader"><input type="submit" onclick="searchCompanyValueatRisk(event, '下市櫃');" size="5" value="搜尋"></a>
			</span>
			</form>
		</div>
		...
		(function(window, document, undefined) {
				...
				var gridColSortTypes = ["string", "string", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number", "number"], 
					gridColAlign = [];
	...
	if ( isset($_GET['search']) ) {
		...
		?>
		<script type="text/javascript">
			searchCompany("<?php echo $str ;?>", '下市櫃');
		</script>
		<?php
	}
